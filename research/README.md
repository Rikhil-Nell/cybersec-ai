...
Source material for the **AI & Cybersecurity** presentation deck and chatbot demo.
...
- Update dates and verification flags before each workshop.
- Items marked ⚠️ need official source confirmation before verbatim citation.
- Slide content is derived from these docs via [`content/slides.ts`](../content/slides.ts).
